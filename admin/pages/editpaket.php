<head>
    ...
    <title>NeoBlue | Tambah Paket</title>
    ...
    <div class="page-inner">
        <div class="page-header">
            ...
            <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                    <a href=".?hal=tambahpaket">Edit Paket</a>
                </li>
            </ul>
        </div>
                        ...
                        <form action="proses_simpan_paket.php" method="POST">
                            ...
                            <div class="form-group">
                                <div class="form-check form-switch">
                                    ...
                                    <small class="form-text text-muted d-block">Aktifkan jika paket ini direkomendasikan, non-aktifkan untuk paket standar.</small>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="fitur[]" value="1" id="f1">
                                    <label class="form-check-label" for="f1">Akses Video Materi (7 Subtest)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="fitur[]" value="2" id="f2">
                                    <label class="form-check-label" for="f2">Akses Liveclass & Rekaman</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="fitur[]" value="3" id="f3">
                                    <label class="form-check-label" for="f3">Akses Smart Scrolling (100+)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="fitur[]" value="4" id="f4">
                                    <label class="form-check-label" for="f4">Akses Habit Harian (1000+ Soal)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="fitur[]" value="5" id="f5">
                                    <label class="form-check-label" for="f5">Akses Tryout Rutin (20x)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="fitur[]" value="6" id="f6">
                                    <label class="form-check-label" for="f6">Akses Pembahasan Tryout (20x)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="fitur[]" value="7" id="f7">
                                    <label class="form-check-label" for="f7">Akses Tracker Kemajuan</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="fitur[]" value="8" id="f8">
                                    <label class="form-check-label" for="f8">Grup Komunitas (Jalur Langit & Discord)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="fitur[]" value="9" id="f9">
                                    <label class="form-check-label" for="f9">Akses Mentoring Persiapan</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="fitur[]" value="10" id="f10">
