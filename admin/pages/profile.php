                    ...
                    <form id="profileUpdateForm" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-12">
                                ...
                                <small class="form-text text-muted">Diperlukan untuk verifikasi jika Anda ingin mengubah password.</small>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-12">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const passwordSekarangInput = document.getElementById('password_sekarang');
    ...
    profileForm.addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('../api/api_profile.php', { method: 'POST', body: formData });
            const result = await response.json();
            if (result.status === 'success') {
                showModal('suksesModal', result.message);
                passwordSekarangInput.value = '';
